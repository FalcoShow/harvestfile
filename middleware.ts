...
// Deploy 6B-final: Added /api/generate-pdf route exclusion for PDF downloads
...
// CRITICAL: Stripe webhook, SMS webhooks, geo detection, PDF generation,
// sitemaps, and robots.txt are EXCLUDED to prevent 307 redirects.
// =============================================================================
...
export async function middleware(request: NextRequest) {
  ...
  if (
    ...
    pathname.startsWith('/api/generate-pdf') ||        // Deploy 6B-final: PDF report download
