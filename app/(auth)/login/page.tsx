// =============================================================================
// HarvestFile — Login Page (Phase 12 v2)
// Ruthlessly minimal. Email + password + gold CTA + Google.
// Matches the signup page environment but strips all marketing.
...
function LoginForm() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h1 className="text-[22px] sm:text-[26px] font-extrabold text-white tracking-[-0.03em]">
          Welcome back
        </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          <label htmlFor="login_email" className="block text-[13px] font-medium text-white/50">
            Email address
          </label>
          <input
            id="login_email"
        ...
        >
          <div className="flex items-center justify-between">
            <label htmlFor="login_pw" className="block text-[13px] font-medium text-white/50">
              Password
            </label>
            <button
              type="button"
              onClick={handleReset}
              className="text-[11px] text-white/25 hover:text-[#C9A84C] transition-colors"
            >
              Forgot password?
            </button>
          </div>
      ...
      >
        <p className="text-[13px] text-white/35">
          ...
          <Link href="/signup" className="text-[#C9A84C] hover:text-[#E2C366] font-medium transition-colors">
            Create one free
          </Link>
        </p>
      </div>
      ...
      fallback={
        <div className="space-y-6">
          <div className="space-y-2 flex flex-col items-center">
            ...
            <div className="h-5 w-56 rounded-lg bg-white/[0.02] animate-pulse" />
          </div>
