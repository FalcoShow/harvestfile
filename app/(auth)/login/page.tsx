// =============================================================================
// HarvestFile — Login Page (Phase 12 v3)
// Bold, substantial, premium. Same card energy as signup.
// =============================================================================
...
function LoginForm() {
  ...
  return (
    <div className="space-y-7">
      {/* ── Header ───────────────────────────────────────── */}
      <div className="text-center space-y-2 hf-auth-stagger" style={{ '--stagger-index': 0 } as React.CSSProperties}>
        <h1 className="text-[28px] sm:text-[32px] font-extrabold text-white tracking-[-0.03em]">
          Welcome back
        </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-1.5 hf-auth-stagger" style={{ '--stagger-index': 1 } as React.CSSProperties}>
          <label htmlFor="login_email" className="block text-[13px] font-semibold text-white/60">Email address</label>
        ...
        <div className="space-y-1.5 hf-auth-stagger" style={{ '--stagger-index': 2 } as React.CSSProperties}>
          <div className="flex items-center justify-between">
            <label htmlFor="login_pw" className="block text-[13px] font-semibold text-white/60">Password</label>
            <button type="button" onClick={handleReset} className="text-[12px] text-[#C9A84C]/60 hover:text-[#C9A84C] transition-colors font-medium">
              Forgot password?
            </button>
          </div>
        ...
        <div className="pt-2 hf-auth-stagger" style={{ '--stagger-index': 3 } as React.CSSProperties}>
      ...
      {/* ── Divider ────────────────────────────────────── */}
      <div className="flex items-center gap-4 hf-auth-stagger" style={{ '--stagger-index': 4 } as React.CSSProperties}>
      ...
      fallback={
        <div className="space-y-7">
          <div className="space-y-2 flex flex-col items-center">
            <div className="h-9 w-48 rounded-lg bg-white/[0.05] animate-pulse" />
            <div className="h-5 w-60 rounded-lg bg-white/[0.03] animate-pulse" />
          </div>
