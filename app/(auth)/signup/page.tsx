  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3 hf-auth-stagger" style={{ '--stagger-index': 2 } as React.CSSProperties}>
        ...
        <span className="text-[12px] text-white/20">or sign up with email</span>
        <div className="flex-1 h-px bg-white/[0.07]" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3.5">
        <div className="hf-auth-stagger" style={{ '--stagger-index': 3 } as React.CSSProperties}>
          <label htmlFor="signup_name" className="block text-[13px] font-semibold text-white/50 mb-1.5">Full name</label>
        ...
        <div className="hf-auth-stagger" style={{ '--stagger-index': 4 } as React.CSSProperties}>
          <label htmlFor="signup_email" className="block text-[13px] font-semibold text-white/50 mb-1.5">Email address</label>
        ...
        <div className="hf-auth-stagger" style={{ '--stagger-index': 5 } as React.CSSProperties}>
          <label htmlFor="signup_pw" className="block text-[13px] font-semibold text-white/50 mb-1.5">Password</label>
          ...
          {password.length > 0 && (
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-[10px] font-bold min-w-[34px] text-right" style={{ color: strength.color }}>{strength.label}</span>
            </div>
          )}
        </div>

        {/* Gold CTA */}
        <div className="pt-1.5 hf-auth-stagger" style={{ '--stagger-index': 6 } as React.CSSProperties}>
