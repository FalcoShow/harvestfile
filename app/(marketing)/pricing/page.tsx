...
// Phase 23 Build 2: Stripe Checkout Integration
//
// Auth-aware CTAs:
      ...
      <section className="relative z-10 mx-auto max-w-[700px] px-5 sm:px-6 pb-16 sm:pb-24">
        <ScrollReveal>
          <div className="rounded-[20px] p-7 sm:p-10 text-center" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            <h3 className="text-[22px] sm:text-[26px] font-extrabold text-white tracking-[-0.02em] mb-3">6 Free Tools for Every Farmer</h3>
            <p className="text-[14px] text-white/30 leading-relaxed max-w-[440px] mx-auto mb-6">ARC/PLC Calculator, Election Optimizer, Payment Scanner, Base Acre Calculator, SDRP Checker, and Policy Calendar &mdash; all free, forever.</p>
